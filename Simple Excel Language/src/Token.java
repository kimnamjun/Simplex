public class Token {
	...
	public static final Token boolTok = new Token(TokenType.Bool, "boolean");
	...
	public static final Token squareTok = new Token(TokenType.Square, "^");
	public static final Token squarerootTok = new Token(TokenType.Squareroot, "^/");
	public static final Token andTok = new Token(TokenType.And, "&");
	public static final Token orTok = new Token(TokenType.Or, "|");
	
	public static final Token sumTok = new Token(TokenType.Sum, "sum");
	public static final Token avgTok = new Token(TokenType.Avg, "avg");
	public static final Token minTok = new Token(TokenType.Min, "min");
	public static final Token maxTok = new Token(TokenType.Max, "max");
	public static final Token showTok = new Token(TokenType.Show, "show");
	public static final Token getTok = new Token(TokenType.Get, "get");
	public static final Token sortTok = new Token(TokenType.Sort, "sort");
